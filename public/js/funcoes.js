...
function getResumopedido() { 
    $.ajax({
        method: "POST",
        url: "/exec/pedido/resumo_pedido/?hashsss="+identsss,
        dataType: "json"
    }).done(function(retorno){
        if(retorno.res === true){
            resumoitenspedd = retorno.resumo;
            rendResumo(retorno);
        }else{
...
function rendEndereco(dados,atualiza){
    ...
    htmEnderecos += "<strong>"+titlEnd + "</strong><br>"
                ...
                + "<a class='removerendereco' href='#' >x</a>"
                + "<a class='editarendereco' href='#' data-toggle='modal' data-backdrop='static' data-keyboard='false'  data-target='#ModalNovoEndereco' >editar</a>";
    if(atualiza === undefined){
        htmEnderecos += "</div>";
